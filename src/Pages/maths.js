            ...
            <React.Fragment>
                <div>
                    ...
                    <div style={{minHeight:"70vh"}} >
                        ...
                        <div className="wrap" >
                            <div style={{ textAlign: "left", margin: "20px 0px" }} className="kids-courses" >
                                <ul className="kids-content" style={{fontSize:"20px"}} >
                                    <li style={{lineHeight:"50px"}} >Help build a solid foundation in basic Math concepts that are taught in grade school</li>
